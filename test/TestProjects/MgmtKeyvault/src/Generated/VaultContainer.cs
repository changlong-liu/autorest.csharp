...
namespace MgmtKeyvault
{
    ...
    public partial class VaultContainer : ArmContainer
    {
        ...
        internal VaultContainer(ArmResource parent) : base(parent)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VaultContainer.GetIfExists");
            scope.Start();
            try
            {
                if (vaultName == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VaultContainer.CheckIfExists");
            scope.Start();
            try
            {
                if (vaultName == null)
        ...
        public virtual Pageable<Vault> GetAll(int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("VaultContainer.GetAll");
                scope.Start();
                try
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VaultContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
